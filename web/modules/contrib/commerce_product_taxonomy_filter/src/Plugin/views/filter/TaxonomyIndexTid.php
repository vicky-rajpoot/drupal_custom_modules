...
namespace Drupal\commerce_product_taxonomy_filter\Plugin\views\filter;
 ...
 *
 * @ViewsFilter("commerce_product_taxonomy_index_tid")
 */
class TaxonomyIndexTid extends ManyToOne {
  ...
  public function acceptExposedInput($input) {
    ...
    // We can say that,
    // Our input conditions are met by just having the right operator.
  ...
  public function getCacheContexts() {
    ...
    // The result potentially depends on term access,
    // And so is just cacheable per user.
    // @todo See https://www.drupal.org/commerce_product/2352175.
    $contexts[] = 'user';
